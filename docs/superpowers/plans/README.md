...
| [2026-06-26 — Social Sign-In: Finish Config, Prod Migrations & Verification](in-progress/2026-06-26-social-sign-in-finish-config-and-verification.md) (sub-issue of design spec #51) | Authoritative end-to-end finish checklist to close #51 |
...
| [2026-07-19 — Working Mobile Dev Environment](_done/2026-07-19-dev-environment.md) | 2026-07-19 — dev-client APK built + installed, `pnpm mobile:run` wired, guest/email/Google sign-in verified against the local Supabase stack, preview build green |
