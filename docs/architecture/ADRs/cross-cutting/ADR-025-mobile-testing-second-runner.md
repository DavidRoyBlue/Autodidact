# ADR-025: Mobile testing strategy and second test runner
...
[ADR-026](./ADR-026-e2e-testing-strategy.md); this ADR covers the unit/component
...
- The full e2e strategy (API-level, cross-service) — owned by [ADR-026](./ADR-026-e2e-testing-strategy.md).
...
### Follow-up
- Mobile e2e tool choice (Maestro) — [ADR-026](./ADR-026-e2e-testing-strategy.md).
