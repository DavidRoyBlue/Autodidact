# ADR-024: End-to-end testing strategy
...
- Mobile unit/component layer and the second-runner decision — owned by [ADR-023](./ADR-023-mobile-testing-second-runner.md).
...
[ADR-023](./ADR-023-mobile-testing-second-runner.md).
...
### Follow-up
- Mobile unit/component layer + second-runner rule — [ADR-023](./ADR-023-mobile-testing-second-runner.md).
